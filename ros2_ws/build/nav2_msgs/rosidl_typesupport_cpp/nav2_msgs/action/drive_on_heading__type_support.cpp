...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, nav2_msgs, action, DriveOnHeading_SendGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<nav2_msgs::action::DriveOnHeading_SendGoal>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, nav2_msgs, action, DriveOnHeading_GetResult)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<nav2_msgs::action::DriveOnHeading_GetResult>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_action_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_cpp, nav2_msgs, action, DriveOnHeading)() {
  return ::rosidl_typesupport_cpp::get_action_type_support_handle<nav2_msgs::action::DriveOnHeading>();
}
